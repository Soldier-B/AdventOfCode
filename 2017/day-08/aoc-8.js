function aoc_8_1(instructions){
    ...
    instructions.forEach(function(instruction){
        ...
        if(eval((regs[ops[4]] || 0) + ops[5] + ops[6]))
            regs[ops[0]] = (regs[ops[0]] || 0) + +ops[2] * (ops[1] == 'inc' ? 1 : -1);
        
        max2 = Math.max(max2, regs[ops[4]] || 0);
    });    

    max1 = Object.keys(regs).reduce(function(m, key){
        return Math.max(m, regs[key]);

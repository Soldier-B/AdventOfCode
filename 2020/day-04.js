...
function part1(passport){
	return attrs.every(attr => attr in passport);
}

function part2(passport){
	return attrs.every(attr => (attr in passport) && validator[attr](passport[attr]));
}

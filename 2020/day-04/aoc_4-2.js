var validate = {
	byr: function(value){
		...
		var n = +value;
		return /^\d{4}$/.test(value) && n > 1919 && n < 2003;
	},
	iyr: function(value){
		// iyr: 4 digits, 2010-2020
		var n = +value;
		return /^\d{4}$/.test(value) && n > 2009 && n < 2021;
	},
	eyr: function(value){
		// eyr: 4 digits, 2020-2030
		var n = +value;
		return /^\d{4}$/.test(value) && n > 2019 && n < 2031;
	},
	hgt: function(value){
		// hgt: number + cm or in, cm 150-193, in 59-76
		var m = /^(\d+)(in|cm)/.exec(value);
		if(m){
			var h = +m[1];
			if(m[2] == 'in')
				return h > 58 && h < 77;
...
function aoc_4_2(data){
	// byr, iyr, eyr, ght, hcl, ecl, pid, [cid]
	var valid = 0,
		passport = null;
	// read data
	for(var row of data){
...
function isvalid(passport){
	if(passport)
		return ['byr','iyr','eyr','hgt','hcl','ecl','pid']
			.every(attr => (attr in passport) && validate[attr](passport[attr]));
	return false;
}
